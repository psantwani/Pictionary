...
function waitingForPlayerNotification(room) {
  ...
  Swal.fire({
    ...
    html: `<p>Game will wait for <b></b> seconds for other players to join.<p>
      <input onClick="this.select();" type='text' value='http://piyushgames.mooo.com/${path}' style="border:1px solid; border-radius:5px; margin-top:10px; width:200px; padding:10px" />
    `,
    timer: 180000,
    timerProgressBar: true,
    onBeforeOpen: () => {
